...
OrbVis is currently in beta. Security fixes are provided for the latest
...
OrbVis is maintained by a small team; we cannot guarantee 24/7 response,
but we take security reports seriously and will keep you informed of
progress.
...
- The OrbVis frontend (`frontend/`), Vue components, board rendering,
  state handling.
- The MKP installer (`make_mkp.sh`, `orbvis-setup`), OMD-site integration,
