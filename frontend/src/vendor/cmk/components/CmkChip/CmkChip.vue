...
.cmk-chip {
    ...
    &.cmk-chip--color-blue {
        --chip-color: var(--color-light-blue-50, #28a2f3);
    }
    ...
    &.cmk-chip--color-red {
        --chip-color: var(--color-light-red-60, #ff5959);
        --chip-fill-font-color: var(--white);
    }

    &.cmk-chip--color-pink {
        --chip-color: var(--color-pink-50, #ff7ec2);
    }

    &.cmk-chip--color-grey {
        --chip-color: var(--color-mid-grey-50, #6b6b6b);
        --chip-outline-font-color: var(--font-color);
    }

    &.cmk-chip--color-purple {
        --chip-color: var(--color-purple-50, #c084fc);
    }

    &.cmk-chip--color-cyan {
        --chip-color: var(--color-cyan-50, #22d3ee);
    }
    ...
    &.cmk-chip--size-small {
        .cmk-chip__content {
            font-size: 10px;
            padding: var(--dimension-1, 1px) var(--dimension-3, 6px);
    ...
    &.cmk-chip--size-medium {
        .cmk-chip__content {
            font-size: 12px;
            padding: var(--dimension-2, 2px) var(--dimension-4, 8px);
    ...
    &.cmk-chip--size-large {
        .cmk-chip__content {
            font-size: 14px;
            padding: 3px var(--dimension-4, 8px);
            gap: 6px;
        }
    }
    ...
    &.cmk-chip--variant-outline {
        .cmk-chip__content {
            background-color: var(--ux-theme-0, var(--bg));
            border: 1px solid var(--chip-color);
