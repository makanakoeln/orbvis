  ...
  update: (
    ...
    request(
      `/boards/${name}`,
      {
        ...
        headers: ifMatch != null ? ({ 'If-Match': String(ifMatch) } as Record<string, string>) : {}
      },
      token
    ),
...
export const connectionsApi = {
  ...
  hostGeo: (
    ...
    request(`/connections/${connectionId}/host-geo?host=${encodeURIComponent(host)}`, {}, token),
  ...
  testConnection: (
    ...
    request('/connections/test-connection', { method: 'POST', body: JSON.stringify(data) }, token)
}
