<template>
  <div class="flex-1 overflow-auto bg-[var(--bg)] p-6">
    ...
    <!-- Grid -->
    <div class="grid gap-2.5" style="grid-template-columns: repeat(auto-fill, minmax(200px, 1fr))">
      <div
      ...
      >
        ...
        <div class="flex items-start justify-between gap-2 mb-2">
          ...
          <div class="flex gap-1 shrink-0 mt-0.5">
            <span v-if="state.acknowledged" title="Acknowledged" class="text-zinc-400 opacity-70">
              <svg
                class="w-3 h-3"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <span v-if="state.in_downtime" title="In downtime" class="text-zinc-400 opacity-70">
              <svg
                class="w-3 h-3"
                fill="none"
                viewBox="0 0 24 24"
