...
import type { BoardObject, ObjectState, ServicesSummary } from '@/types/api'

import { useSummaryChips } from './useSummaryChips'

function obj(type: BoardObject['type'], extra: Partial<BoardObject> = {}): BoardObject {
...
function setup(object: BoardObject | null, st: ObjectState | undefined) {
