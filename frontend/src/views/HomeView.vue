  ...
  <div class="flex-1 overflow-y-auto bg-[var(--bg)]">
    <main class="max-w-5xl mx-auto py-10 px-6 pb-24">
      <div class="mb-8 flex items-center justify-between gap-4">
        ...
        <button v-if="auth.isAdmin" data-tour="new-board" @click="showCreate = true"
  ...
  <Teleport to="body">
    <div v-if="confirmClone" class="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div class="relative bg-[var(--bg-surface)] ring-1 ring-[var(--border)] shadow-2xl shadow-black/50 rounded-2xl p-6 w-80 space-y-3">
        ...
        <div>
          <label class="block text-xs font-medium text-zinc-400 mb-1.5">{{ t('admin.boardId') }}</label>
          <input
            ref="cloneInputEl"
            :value="cloneNewName"
        ...
        <div>
          <label class="block text-xs font-medium text-zinc-400 mb-1.5">{{ t('admin.alias') }}</label>
