export default {
  ...
  home: {
    ...
    viewCards: 'Kacheln',
    viewTable: 'Tabelle',
    viewCardsTitle: 'Als Kachelraster anzeigen',
    viewTableTitle: 'Als Tabelle anzeigen',
    colName: 'Name',
    colType: 'Typ',
  ...
  board: {
    ...
    ftEmptyHosts: 'leer · 0 Hosts',
    ftAck: 'Quittiert',
    ftDowntime: 'In Wartung',
    ftFlapping: 'Flattert',
    ftSince: 'Seit letztem Statuswechsel',
    ftLoadingServices: 'Lade Services…',
    ftServicesLoadError: 'Services konnten nicht geladen werden',
    ftNoServices: 'Keine Services',
    ...
    ftBulkAffects: 'Betrifft {count} Hosts in „{folder}".',
    ftBulkRecursive: 'Unterordner einbeziehen',
    ftBulkDuration: 'Dauer',
    ftBulkDone: '{count} Hosts erledigt.',
    ftBulkAckSubmit: '{count} Hosts quittieren',
    ftBulkDowntimeSubmit: '{count} Hosts in Wartung',
    ...
    ftRootFolderPlaceholder: 'alle Ordner',
    ftExpandDepth: 'Auto-Aufklapptiefe',
    ...
    hover: {
      ...
      notificationsDisabled: 'Benachrichtigungen deaktiviert — bei Problemen wird nichts gemeldet'
    },
    flow: {
    ...
    search: {
      placeholder: "Suchen — '/' für Operatoren",
      clear: 'Suche leeren',
      operatorHelpTitle: 'Suchoperatoren einblenden',
      operatorDropdownTitle: "'/' tippen, um einen Suchoperator zu wählen",
      operatorInfo:
        'Ohne Präfix wird in allen Feldern gesucht. Mehrere Begriffe werden UND-verknüpft.',
      operator: {
        host: 'Host',
        service: 'Service',
        hostgroup: 'Hostgruppe',
        servicegroup: 'Servicegruppe',
        id: 'Objekt-ID'
      }
    },
    detailDrawer: {
  ...
  boardSettings: {
    ...
    metric: 'Metrik',
    metricIn: 'Metrik (in)',
    metricOut: 'Metrik (out)',
    firstMetric: 'erste Metrik',
    secondMetric: 'zweite Metrik (optional)',
    startX: 'Anfang X',
    endX: 'Ende X',
  ...
  contextMenu: {
    ...
    straightenLine: 'Knick entfernen',
  ...
  admin: {
    ...
    selectBoards: 'Auswählen',
    exitSelect: 'Fertig',
    selectAll: 'Alle auswählen',
    selectAllVisible: 'Alle auswählen ({n} sichtbar)',
    deleteN: '{n} löschen',
    nSelected: '{n} ausgewählt',
    bulkDeleteTitle: '{n} Boards löschen',
    bulkDeleteIntro: 'Folgende Boards werden unwiderruflich entfernt:',
    bulkDeleteMore: '… und {n} weitere',
    bulkDeleteSuccess: '{n} Boards gelöscht',
    bulkDeletePartial: '{ok} gelöscht, {fail} fehlgeschlagen',
    bulkDeleteFailedHeader: 'Einige Boards konnten nicht gelöscht werden:',
    bulkEditN: '{n} bearbeiten',
    bulkExportN: '{n} exportieren',
    bulkEditTitle: '{n} Boards bearbeiten',
    bulkEditIntro:
      'Haken Sie die Felder an, die für alle ausgewählten Boards überschrieben werden sollen. Nicht angehakte Felder bleiben unverändert.',
    bulkEditPreviewMore: '{head}, … und {n} weitere',
    bulkEditApply: 'Auf {n} Boards anwenden',
    bulkEditSuccess: '{n} Boards aktualisiert',
    bulkEditPartial: '{ok} aktualisiert, {fail} fehlgeschlagen',
    bulkEditNoneEditable:
      'Keines der ausgewählten Boards ist editierbar (alle sind schreibgeschützt).',
    bulkEditSchemaError: 'Bulk-Edit-Formular konnte nicht geladen werden.',
    bulkExportSuccess: '{n} Boards exportiert',
    ...
    connectionIdInvalid: 'Nur Buchstaben, Ziffern, Bindestriche (-) und Unterstriche (_) erlaubt',
    ...
    livestatusTransport: 'Transport',
    livestatusTransportSocket: 'Unix-Socket',
    livestatusTransportTcp: 'TCP',
    tcpHost: 'TCP-Host',
    fieldRequired: 'Pflichtfeld',
    saveBlocked: 'Bitte zuerst korrigieren:',
    port: 'Port',
  ...
  settings: {
    ...
    logging: 'Logging',
    logLevel: 'Log-Level',
    logLevelHint: 'Schwellwert für die Backend-Logs. Wird sofort übernommen, kein Neustart nötig.',
    features: 'Funktionen',
