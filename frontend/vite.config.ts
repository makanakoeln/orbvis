...
const STANDALONE_COMPONENT_MAP: Record<string, string> = {
  ...
  'CmkCollapsible/CmkCollapsible.vue': 'CmkCollapsible/CmkCollapsible.vue',
  'CmkColorPicker.vue': 'CmkColorPicker.vue',
  ...
  'CmkPopup.vue': 'CmkPopup.vue',
  'CmkPopupDialog.vue': 'CmkPopupDialog.vue',
  'CmkScrollContainer.vue': 'CmkScrollContainer.vue',
  'CmkSlideInDialog.vue': 'CmkSlideInDialog.vue',
  'CmkSwitch.vue': 'CmkSwitch.vue',
  'CmkToggleButtonGroup.vue': 'CmkToggleButtonGroup.vue',
...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // Stand ~28% (viele views/* und components/* sind noch untested).
