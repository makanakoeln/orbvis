...
from cmk.orbvis_backend.schemas.auth import TokenResponse
from cmk.orbvis_backend.schemas.user import UserCreate
...
async def _authenticate_token(
    ...
    from cmk.orbvis_backend.core.security import decode_token, is_token_blocked
