...
from cmk.orbvis_backend.connections.base import topology_problem_rank
...
from cmk.orbvis_backend.services.state_service import register_connection as _register
...
def delete(connection_id: str) -> bool:
    ...
    # map states and the warmup loop keeps polling the deleted backend
...
def build_instance(cfg: ConnectionConfig) -> ConnectionBase:
    ...
    if cfg.type == "icinga2":
        from cmk.orbvis_backend.connections.icinga2 import Icinga2Connection
