...
from cmk.orbvis_backend.api.v1.deps import get_current_user, require_configure
...
from cmk.orbvis_backend.schemas.settings import GlobalSettings, LogLevel, SystemSettings
...
if FORM_SPECS_AVAILABLE:
    ...
    from cmk.orbvis_backend.form_specs.global_settings import global_settings_spec
    from cmk.orbvis_backend.form_specs.system_settings import system_settings_spec
...
if FORM_SPECS_AVAILABLE:
    ...
    def _system_to_form(s: SystemSettings) -> dict[str, object]:
        ...
        out["enable_folder_maps"] = s.enable_folder_maps
        out["enable_graph_objects"] = s.enable_graph_objects
        out["enable_presentation_maps"] = s.enable_presentation_maps
        return out
    ...
    def _system_from_form(form: dict[str, object]) -> SystemSettings:
        ...
        try:
            return SystemSettings(
                ...
                enable_folder_maps=bool(form.get("enable_folder_maps", False)),
                enable_graph_objects=bool(form.get("enable_graph_objects", True)),
                enable_presentation_maps=bool(form.get("enable_presentation_maps", False)),
            )
        except ValidationError as e:
