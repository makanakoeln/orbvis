...
from cmk.orbvis_backend.core.ratelimit import login_limiter
from cmk.orbvis_backend.core.security import (
    STREAM_TICKET_TTL,
    blocklist_token,
    create_access_token,
...
from cmk.orbvis_backend.integrations.checkmk import load_user_inline_help
from cmk.orbvis_backend.models.user import User
from cmk.orbvis_backend.schemas.auth import LoginRequest, RefreshRequest, StreamTicketResponse, TokenResponse
from cmk.orbvis_backend.schemas.user import UserRead
from cmk.orbvis_backend.services.auth_service import (
    authenticate_user,
...
async def me(current_user: User = Depends(get_current_user)) -> UserRead:
    ...
    result.can_create_maps = can_create_map(current_user)
