...
from cmk.orbvis_backend.connections.base import (
    BI_INT_TO_STATE,
    ConnectionBase,
    FolderInfo,
    FolderTreeData,
...
from cmk.orbvis_backend.integrations import checkmk as _cmk_integration
from cmk.orbvis_backend.integrations import checkmk_sites as _cmk_sites
from cmk.orbvis_backend.integrations.checkmk import FolderScope
from cmk.orbvis_backend.integrations.cmk_plugins import load_cmk_graphing_data
from cmk.orbvis_backend.schemas.map import AggregationInfo, AggregationNode
...
from cmk.orbvis_backend.services.perfometer_service import metric_title, metric_titles, translate_metric_names
...
class LivestatusConnection(ConnectionBase):
    ...
    def __init__(
        ...
        # high-fanout flow-map burst doesn't rebuild the context per
        # connection.
        self._tls = tls
        ...
        self._bulk_chunk_semaphore = asyncio.Semaphore(
            settings.flow_map_bulk_max_concurrent_chunks
        )
    ...
    async def _open_connection(
        ...
        High-fanout flow-map fetches (top-K with hundreds of hosts) burst many
