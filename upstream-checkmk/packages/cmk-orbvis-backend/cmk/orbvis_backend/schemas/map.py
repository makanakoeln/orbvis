...
from cmk.orbvis_backend.schemas.presentation import PresentationView
...
def _coerce_color(value: object) -> object:
    ...
    re-saving the map through the API still rejects bad input.
    """
    if value is None or value == "":
        return value
...
class MapConfig(BaseModel):
    ...
    # Default keeps existing maps on the OrbVis renderer; "nagvis_classic"
    ...
    view: MapView = Field(default_factory=StaticView)
