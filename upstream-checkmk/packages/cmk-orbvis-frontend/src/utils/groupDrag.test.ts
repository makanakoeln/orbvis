...
function obj(id: string, type: MapObject['type'], x = 0, y = 0): MapObject {
  return { id, type, x, y, url_target: '' }
}

const project = (o: MapObject): [number, number] | null => [o.x, o.y]
...
describe('collectGroupMembers', () => {
  ...
  it('skips objects whose projection returns null', () => {
    const sparseProject = (o: MapObject): [number, number] | null =>
      o.id === 'b' ? null : [o.x, o.y]
