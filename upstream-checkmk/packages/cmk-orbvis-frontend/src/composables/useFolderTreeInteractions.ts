...
import type { MapObject, FolderTreeNode, MonitoringState, ObjectState } from '@/types/api'
 ...
 * foldertree map. Foldertree leaves never enter the SSE state map (services
