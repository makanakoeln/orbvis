...
declare module '@/cmk-additions/components/CmkDialog.vue' {
  import type { DefineComponent } from 'vue'
  type ButtonVariant =
    | 'primary'
    | 'secondary'
...
declare module '@/cmk-additions/form/private/FormEditDispatcher/dispatch' {
...
declare module '@/cmk-additions/form/private/forms/FormOrbColor.vue' {
  import type { DefineComponent } from 'vue'
  const component: DefineComponent<Record<string, unknown>>
  export default component
}

declare module '@/cmk-additions/form/private/forms/FormOrbHostAutocomplete.vue' {
  import type { DefineComponent } from 'vue'
  const component: DefineComponent<Record<string, unknown>>
  export default component
}
